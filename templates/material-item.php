 ...
 * always matched on, so the tag filter carries over untouched.
 *
...
<li class="ansp-matrow<?php echo $ansp_checkbox ? '' : ' ansp-matrow--nozip'; ?>" data-ansp-tags="<?php echo esc_attr( $ansp_tags_key ); ?>">
	...
	<div class="ansp-matrow-main">
		<div class="ansp-matrow-titleline">
			<span class="ansp-material-type"><?php echo esc_html( $ansp_type_label ); ?></span>
			<span class="ansp-matrow-title"><?php echo esc_html( $ansp_title ); ?></span>
			<?php if ( $ansp_is_gdoc ) : ?>
